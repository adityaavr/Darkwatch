...
If you terminate early due to being stuck, still estimate the Trust Score and Supply Chain Analysis from whatever pages you did see, leave "junkFeesRemoved" as an empty array, and return the JSON.
...
`
    ...
    for await (const event of stream) {
      if (event.type === 'STREAMING_URL') {
        ...
        clearTimers()
        const result = event.result as SanitizationResult
